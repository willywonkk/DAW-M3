        ...
        do {
            ...
            switch (seleccion) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    mostrarTodasCategorias(); // Opción para listar categorías
                    break;
                case 11:
                    agregarCategoria(); // Opción para insertar categoría
                    break;
                case 12:
                    modificarCategoria(); // Opción para actualizar categoría
                    break;
                case 13:
                    eliminarCategoria(); // Opción para eliminar categoría
                    break;
                case 14:
