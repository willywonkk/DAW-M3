...
public class CineBcn {
    ...
    private static void inicializarCine() {
        cinema = new Cinema("CineBcn", "Calle Principal 123, Barcelona");
        peliculas = new ArrayList<>();
        usuarios = new ArrayList<>();
        reservas = new ArrayList<>();
    }

    // Implementacion de los metodos del menu
    ...
    private static void agregarPelicula() {
        ...
        System.out.print("Ingrese la clasificacion por edades: ");
    ...
    private static List<Butacas> seleccionarButacas(Sala sala) {
        ...
        System.out.println("Seleccione las butacas (ingrese 0 para terminar):");
        while (true) {
            System.out.print("Ingrese el numero de fila (letra): ");
            String fila = scanner.next().toUpperCase();
            if (fila.equals("0")) break;
